...
} __attribute__((aligned(16))) Object_Instance;
...
typedef struct Object_InstanceTable_Infomeation {
    ...
    Object_Instance** pHierarchyTable; // offset 0x8, size 0x4
    Object_Instance* pFreeTable;       // offset 0xC, size 0x4
...
typedef struct Object_Class {
    ...
    u_int Status;                                       // offset 0xC, size 0x4
} Object_Class;
